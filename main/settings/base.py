...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-build-placeholder-key')
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware', # Statik dosyalar için eklendi, Railway için gerekli olabilir
...
# 3. CORS İzinleri (Vercel'deki frontend'in erişebilmesi için)
CORS_ALLOW_ALL_ORIGINS = True # Geliştirme aşamasında True, production'da spesifik domain'ler eklenebilir
